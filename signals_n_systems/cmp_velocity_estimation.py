...
seismic = np.fromfile(f"C:/Users/WINDOWS 10/Documents/Projetos/Git_GISIS_training/GISIS_training/signals_n_systems/cmp_gather_5001x161_1000us.bin", dtype = np.float32, count = nt*nx)
